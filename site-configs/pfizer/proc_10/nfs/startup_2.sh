...
workdir=/nfs/grid/software/io500-tests
...
function setup_ior_easy {
  io500_ior_easy_params="-t 1024k -b 750M -F" # 2M writes, 16 GB per proc, file per proc 
}

function setup_mdt_easy {
  io500_mdtest_easy_params="-u -L" # unique dir per thread, files only at leaves
  io500_mdtest_easy_files_per_proc=2000
}

function setup_ior_hard {
  io500_ior_hard_writes_per_proc=1000
}

function setup_mdt_hard {
  io500_mdtest_hard_files_per_proc=1200
}
